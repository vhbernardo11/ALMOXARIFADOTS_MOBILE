# Vitão Assistente Local — no aparelho

Aplicativo Android baseado no binding oficial do `llama.cpp`.

- Executa o modelo GGUF no próprio Android.
- Baixa uma vez o Qwen3 0.6B Q4_0 (aproximadamente 429 MB).
- Depois do download, funciona sem computador, servidor ou API.
...
- O APK não inclui o modelo: ele é instalado no primeiro uso.
